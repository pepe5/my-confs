...
(custom-set-variables
 ...
 '(ibuffer-saved-filter-groups (quote (("dev-3 vosao|velocity|tomcat" ("text" (or (filename . "/text/"))) ("env" (or (name . "dev-java-uniq\\|sdk") (filename . "^~/local/vosao/$"))) ("skel" (or (filename . "dev-java-uniq\\|local/vosao\\|sdk"))) ("rsrcs stu" (or (filename . "velocity\\|tomcat\\|google\\|mvn\\|ant"))) ("^*" (name . "^*"))) ("dev-2 vosao|velocity|tomcat" ("vosao text" (or (filename . "/text/"))) ("vosao env" (or (name . "dev-java-uniq\\|local/vosao\\|sdk"))) ("vosao skel" (or (filename . "dev-java-uniq\\|local/vosao\\|sdk"))) ("rsrcs stu" (or (filename . "velocity\\|tomcat\\|google\\|mvn\\|ant"))) ("^*" (name . "^*"))) ("task-2 BL~R53 SIP,SUP" ("bl~r53|sip,sup" (or (filename . "bl~\\|r53\\|r5\\.3\\|sip\\|sup"))) ("ttt" (or (filename . "ttt") (name . "ttt"))) ("^*" (name . "^*"))) ("dev-2 velocity|weblog|vosao" ("velocity|weblog|vosao" (or (filename . "velocity\\|weblog\\|vosao\\|weba\\|policy"))) ("log|myjugg" (or (filename . "log\\|myjugg") (name . "log\\|myjugg"))) ("^*" (name . "^*"))) ("dev-2 weblog" ("weblog|dev" (or (filename . "weblog\\|dev"))) ("tmp" (or (filename . "tmp"))) ("^*" (name . "^*"))) ("dev-1" ("log|myjugg" (or (filename . "log\\|myjugg") (name . "log\\|myjugg"))) ("swf|build|git" (or (filename . "swf\\|git") (name . "swf\\|git"))) ("^*" (name . "^*"))) ("tickets-3 cr20662,ttt" ("cr20662|small" (or (filename . "cr20662\\|small"))) ("ttt|for_review" (or (filename . "ttt\\|for_review"))) ("^*" (name . "^*"))) ("g1-stars" ("^*" (name . "^*"))) ("tickets-1" ("47405|ssd-mem" (or (filename . "47405\\|ssd-mem"))) ("55934\\|ghlr" (or (filename . "55934\\|ghlr"))) ("ttt|for_review" (or (filename . "ttt\\|for_review"))) ("^*" (name . "^*"))) ("dev-z1: ooo-ed & rest of tasks" ("tasks - non-ooo-ed+non-*" (name . "^[^*]") (not saved . "ooo-ed"))))))
